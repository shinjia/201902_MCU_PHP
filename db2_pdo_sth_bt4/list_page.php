...
while($row = $sth->fetch(PDO::FETCH_ASSOC))
{
   ...
   $data .= <<< HEREDOC
     <tr align="center">
       ...
       <td>{$weight}</td>
       <td>{$remark}</td>
       <td><a href="display.php?uid=$uid" class="btn btn-primary">詳細</a></td>
       <td><a href="edit.php?uid=$uid"  class="btn btn-info">修改</a></td>
       <td><a href="delete.php?uid=$uid" onClick="return confirm('確定要刪除嗎？');"  class="btn btn-danger">刪除</a></td>
    </tr>
HEREDOC;
}
