...
// 寫出 SQL 語法
$sqlstr = "INSERT INTO book(bookcode, bookname, descr, author, publish, pub_date, price, picture, remark) VALUES ('$bookcode', '$bookname', '$descr', '$author', '$publish', '$pub_date', '$price', '$picture', '$remark') ";
